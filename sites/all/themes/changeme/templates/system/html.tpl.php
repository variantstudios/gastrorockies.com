...
<!--[if gte IE <?php print $minie; ?>]><!--> <html class="no-js" <?php print $html_attributes; ?> <?php print $rdf_attributes; ?>> <!--<![endif]-->
  <head>
    ...
    <?php print $styles; ?>
    <?php print $scripts; ?>
    <script type="text/javascript" src="//use.typekit.net/fvr1ecs.js"></script>
    <script type="text/javascript">try{Typekit.load();}catch(e){}</script>
    <!--[if lt IE 9]><script src="<?php print $GLOBALS['base_url'] . '/' . drupal_get_path('theme', 'mortgagebase'); ?>/js/respond.min.js"></script><![endif]-->
    <!--[if lt IE 9]><script src="<?php print $GLOBALS['base_url'] . '/' . drupal_get_path('theme', 'mortgagebase'); ?>/htmlshim/dist/html5shiv.js"></script><![endif]-->
