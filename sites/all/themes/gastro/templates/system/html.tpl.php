...
<!--[if gte IE <?php print $minie; ?>]><!--> <html class="no-js" <?php print $html_attributes; ?> <?php print $rdf_attributes; ?>> <!--<![endif]-->
  <head>
    ...
    <?php print $styles; ?>
    <?php print $scripts; ?>
    <script type="text/javascript" src="//use.typekit.net/elk2jix.js"></script>
<script type="text/javascript">try{Typekit.load();}catch(e){}</script>
    <!--[if lt IE 9]><script src="<?php print $GLOBALS['base_url'] . '/' . drupal_get_path('theme', 'gastro'); ?>/htmlshim/dist/html5shiv.js"></script><![endif]-->
    <!--[if lt IE 9]><link rel="stylesheet" type="text/css" href="<?php print $GLOBALS['base_url'] . '/' . drupal_get_path('theme', 'gastro'); ?>/css/ie.css" /><![endif]-->
